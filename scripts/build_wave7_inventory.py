"""Build Entrepedia Wave 7 inventory from scrape-desks.json."""
...
def main() -> None:
            ...
            rows.append(
                {
                    ...
                    "status": "queued",
                    "staging_hint": f"iMU-import\\\\wave7\\\\batch-{desk['batch']}\\\\{desk['slug']}",
                }
            )
    ...
    payload = {
        "wave": 7,
        "generated_by": "scripts/build_wave7_inventory.py",
        "note": "Copy / sales / consulting / speaking / networking / AI workflows desks.",

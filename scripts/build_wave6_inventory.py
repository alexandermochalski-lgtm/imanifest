"""Build Entrepedia Wave 6 inventory from scrape-desks.json."""
...
def main() -> None:
            ...
            rows.append(
                {
                    ...
                    "status": "queued",
                    "staging_hint": f"iMU-import\\\\wave6\\\\batch-{desk['batch']}\\\\{desk['slug']}",
                }
            )
    ...
    payload = {
        "wave": 6,
        "generated_by": "scripts/build_wave6_inventory.py",
        "note": "Content engine / security / reputation / audience monetization desks.",

"""Download Wave 8 batch product ZIPs from inventory download_url fields."""
...
inv = json.loads((ROOT / "data/entrepedia-wave8/inventory.json").read_text(encoding="utf-8"))
base = Path(os.environ["USERPROFILE"]) / "OneDrive" / "Desktop" / "iMU-import" / "wave8" / f"batch-{BATCH}"

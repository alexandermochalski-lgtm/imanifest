"""Build Entrepedia Wave 9 inventory from scrape-desks.json."""
...
def main() -> None:
            ...
            rows.append(
                {
                    ...
                    "status": "queued",
                    "staging_hint": f"iMU-import\\\\wave9\\\\batch-{desk['batch']}\\\\{desk['slug']}",
                }
            )
    ...
    payload = {
        "wave": 9,
        "generated_by": "scripts/build_wave9_inventory.py",
        "note": "Wave 9 gap desks for 100+ campus courses.",

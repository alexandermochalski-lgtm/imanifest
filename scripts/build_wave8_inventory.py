"""Build Entrepedia Wave 8 inventory from scrape-desks.json."""
...
def main() -> None:
            ...
            rows.append(
                {
                    ...
                    "status": "queued",
                    "staging_hint": f"iMU-import\\\\wave8\\\\batch-{desk['batch']}\\\\{desk['slug']}",
                }
            )
    ...
    payload = {
        "wave": 8,
        "generated_by": "scripts/build_wave8_inventory.py",
        "note": "Retention / community / storytelling / legal / partnerships / launch desks.",

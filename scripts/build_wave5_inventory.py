"""Build Entrepedia Wave 5 inventory from scrape-desks.json."""
...
def main() -> None:
            ...
            rows.append(
                {
                    ...
                    "status": "queued",
                    "staging_hint": f"iMU-import\\\\wave5\\\\batch-{desk['batch']}\\\\{desk['slug']}",
                }
            )
    ...
    payload = {
        "wave": 5,
        "generated_by": "scripts/build_wave5_inventory.py",
        "note": "Trading / time / negotiation / wealth / ecom / EQ gap desks.",

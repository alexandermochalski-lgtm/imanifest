"""Download Wave 7 batch product ZIPs from inventory download_url fields."""
...
inv = json.loads((ROOT / "data/entrepedia-wave7/inventory.json").read_text(encoding="utf-8"))
base = Path(os.environ["USERPROFILE"]) / "OneDrive" / "Desktop" / "iMU-import" / "wave7" / f"batch-{BATCH}"

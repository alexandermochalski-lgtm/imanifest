"""Download Wave 10 batch product ZIPs from inventory download_url fields."""
...
inv = json.loads((ROOT / "data/entrepedia-wave10/inventory.json").read_text(encoding="utf-8"))
base = Path(os.environ["USERPROFILE"]) / "OneDrive" / "Desktop" / "iMU-import" / "wave10" / f"batch-{BATCH}"

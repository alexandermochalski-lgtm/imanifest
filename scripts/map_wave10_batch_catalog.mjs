/**
 * Map Wave 10 Batch N Blob assets into overlay courses + books.
 * Usage: node scripts/map_wave10_batch_catalog.mjs 1
 */
...
const STAGING = path.join(process.env.USERPROFILE || "", "OneDrive", "Desktop", "iMU-import", "wave10", `batch-${BATCH}`);
const REPORT = path.join(STAGING, "UPLOAD_REPORT.json");

const ALL_DESKS = {
  "coaching-ops-desk": {
    id: "c-w10-coachingops",
    bookId: "b-w10-coachingops",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /coaching|ops|desk/i,
  },
  "offer-builder-desk": {
    id: "c-w10-offerbuilder",
    bookId: "b-w10-offerbuilder",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /offer|builder|desk/i,
  },
  "change-management-desk": {
    id: "c-w10-changemanagement",
    bookId: "b-w10-changemanagement",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /change|management|desk/i,
  },
  "conversion-triggers-desk": {
    id: "c-w10-conversiontrigge",
    bookId: "b-w10-conversiontrigge",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /conversion|triggers|desk/i,
  },
  "sop-systems-desk": {
    id: "c-w10-sopsystems",
    bookId: "b-w10-sopsystems",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /sop|systems|desk/i,
  },
  "journaling-ops-desk": {
    id: "c-w10-journalingops",
    bookId: "b-w10-journalingops",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /journaling|ops|desk/i,
  },
  "money-psychology-desk": {
    id: "c-w10-moneypsychology",
    bookId: "b-w10-moneypsychology",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /money|psychology|desk/i,
  },
  "authentic-marketing-desk": {
    id: "c-w10-authenticmarketi",
    bookId: "b-w10-authenticmarketi",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /authentic|marketing|desk/i,
  },
  "ai-profit-desk": {
    id: "c-w10-aiprofit",
    bookId: "b-w10-aiprofit",
    slug: "ai-profit-desk",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /ai|profit|desk/i,
  },
  "lead-generation-desk": {
    id: "c-w10-leadgeneration",
    bookId: "b-w10-leadgeneration",
    ...
    duration: "Self-paced",
    level: "Practitioner",
    flagshipPdf: /lead|generation|desk/i,
  },
};
...
const DESKS = Object.fromEntries(
  Object.entries(ALL_DESKS).filter(([slug]) => {
    try {
      const inv = JSON.parse(readFileSync(path.join(process.cwd(), "data", "entrepedia-wave10", "inventory.json"), "utf8"));
...
function main() {
  ...
  for (const raw of report.assets) {
    ...
    const live = byUrl.get(raw.url) || {
      id: `m-w10b${BATCH}-${Math.random().toString(36).slice(2, 8)}`,
      title: raw.title,
      kind: raw.kind,
  ...
  const outDir = path.join(process.cwd(), "data", "entrepedia-wave10");

"""Download Wave 6 batch product ZIPs from inventory download_url fields."""
...
inv = json.loads((ROOT / "data/entrepedia-wave6/inventory.json").read_text(encoding="utf-8"))
base = Path(os.environ["USERPROFILE"]) / "OneDrive" / "Desktop" / "iMU-import" / "wave6" / f"batch-{BATCH}"

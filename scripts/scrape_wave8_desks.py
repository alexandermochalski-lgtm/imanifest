"""Scrape Entrepedia Wave 8 desks (retention / community / storytelling / legal / partnerships / launches).

Usage:
  python scripts/scrape_wave8_desks.py
"""
...
OUT = ROOT / "data" / "entrepedia-wave8"
...
DESKS = [
    {
        ...
        "queries": ["customer retention", "customer loyalty", "ltv", "win back customers", "repeat customers"],
        "title_any": ["retention", "loyalty", "ltv", "lifetime value", "win-back", "win back", "repeat customer", "churn"],
        "title_none": ["tiktok", "instagram", "meta ads", "youtube ads", "cold email"],
        "max": 8,
    },
    {
        "slug": "ugc-ops-desk",
        ...
        "title_any": ["ugc", "user-generated", "user generated", "creator content collection"],
    ...
    },
    {
        ...
        "batch": 1,
        "q": "storytelling",
        "queries": ["brand storytelling", "founder story", "storytelling marketing", "narrative brand", "brand story"],
        "title_any": ["story", "narrative", "brand story", "founder story", "storytell", "storytelling"],
        "title_none": ["tiktok", "instagram", "meta ads", "youtube ads", "seo", "aeo"],
        "max": 7,
    },
    {
        "slug": "legal-ops-desk",
        ...
        "batch": 2,
        "q": "business legal",
        "queries": ["business contracts", "legal for entrepreneurs", "terms of service", "llc", "intellectual property business", "gdpr compliance"],
        "title_any": ["legal", "contract", "llc", "terms", "trademark", "copyright", "compliance", "liability", "agreement", "gdpr", "cookie"],
        "title_none": ["tiktok", "instagram", "meta ads", "meditation", "yoga"],
        "max": 7,
    },
    {
        ...
        "title_any": ["franchise", "franchising", "replicable"],
        "title_none": ["tiktok", "instagram", "dating", "yoga"],
        "max": 8,
    },
    {
        ...
        "batch": 2,
        "q": "product launch",
        "queries": ["product launch", "launch strategy", "product launch checklist", "go to market", "waitlist launch"],
        "title_any": ["launch", "go-to-market", "go to market", "waitlist", "pre-launch", "product release", "launch day"],
        "title_none": ["tiktok", "instagram", "rocket", "spacex"],
        "max": 8,
    },
]

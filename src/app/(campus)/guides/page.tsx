  ...
  return (
    <main>
      ...
      <div className="mt-6 flex flex-wrap gap-2 text-xs">
        <Link href="/guides" className="rounded-full border border-[var(--line)] px-3 py-1 text-gold">
          All
        </Link>
        {allTags.map((item) => (
          <Link
        ...
        {filtered.map((guide) => {
          ...
          return (
            <Link
              ...
              className="overflow-hidden rounded-2xl border border-[var(--line)] bg-panel"
            >
              {cover ? (
              ...
              <div className="p-6">
                {guide.series ? <p className="text-[10px] uppercase tracking-[0.18em] text-gold-deep">{guide.series}</p> : null}
